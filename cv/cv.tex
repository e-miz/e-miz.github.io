...
\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2017}}: University of
Maryland at College Park, \textbf{PhD Physics (exp. Dec 2023)}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2013 - Dec 2015}}: UC
Berkeley, \textbf{B.A. Physics}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2011 - May 2013}}: San
Diego Mesa Community College, \textbf{A.S. Physics with High Honors}

\hangindent=0.4in \textcolor{mygray}{\textit{Sep 2008 - Jun 2011}}:
Bonita Vista High School, \textbf{International Baccalaureate Diploma}

\hypertarget{fa-school-teaching}{%
\section{\texorpdfstring{\faIcon{school}
Teaching}{ Teaching}}\label{fa-school-teaching}}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2017 - Dec 2019}}: UMD
Undergraduate Physics for Biologists I \& II, \textbf{Graduate Teaching
Assistant}

\hangindent=0.4in \textcolor{mygray}{\textit{Jan 2016 - May 2016}}: UC
Berkeley Frontiers of Physics, \textbf{Co-teacher}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2015 - Dec 2015}}: UC
Berkeley Undergraduate Particle Physics, \textbf{Grader}

\hypertarget{fa-atom-research}{%
\section{\texorpdfstring{\faIcon{atom}
Research}{ Research}}\label{fa-atom-research}}

\hangindent=0.4in \textcolor{mygray}{\textit{Jun 2019}}: LLNL RED Group,
\textbf{Graduate Research Assistant}

\hangindent=0.4in \textcolor{mygray}{\textit{Sep 2018 - Jun 2019}}: UMD
Hall Group, \textbf{Graduate Research Assistant}\newline I have
Information!

\hangindent=0.4in \textcolor{mygray}{\textit{Jun 2018 - Aug 2018}}: UMD
Lobb Group, \textbf{Graduate Research Assistant}

\hangindent=0.4in \textcolor{mygray}{\textit{Jul 2016 - Jun 2017}}: SLAC
PAC Noble Liquids Group, \textbf{Technician}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2015 - Jun 2016}}: LBNL
Sorensen Group, \textbf{Research Affiliate}

\hangindent=0.4in \textcolor{mygray}{\textit{Jun 2015 - Aug 2015}}: UC
Davis Tripathi Group, \textbf{Research Assistant}

\hangindent=0.4in \textcolor{mygray}{\textit{Jan 2015 - May 2015}}: LBNL
Sorensen Group, \textbf{Research Affiliate}

\hangindent=0.4in \textcolor{mygray}{\textit{Jun 2014 - Dec 2014}}: UC
Berkeley Mueller Group, \textbf{Research Assistant}
...
\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2020 - Aug 2021}}: US
Department of Energy Office of Science, \textbf{Graduate Student
Research Award}

\hangindent=0.4in \textcolor{mygray}{\textit{May 2019}}: Ralph Meyers \&
Friends of Physics Outstanding Teaching Abilities, \textbf{2nd Place}

\hangindent=0.4in \textcolor{mygray}{\textit{Apr 2019}}: University of
Maryland Graduate School, \textbf{Summer Research Fellowship}

\hangindent=0.4in \textcolor{mygray}{\textit{May 2018}}: Ralph Meyers \&
Friends of Physics Outstanding Teaching Abilities, \textbf{Honorable
Mention}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2017}}: University of
Maryland Graduate School, \textbf{Dean's Fellowship}
...
\hangindent=0.4in \textcolor{mygray}{\textit{Dec 2022}}: LZ Equity and
Inclusion Committee, \textbf{Member}

\hangindent=0.4in \textcolor{mygray}{\textit{Nov 2021 - Dec 2022}}: LZ
Graduates Engineers Technicians Undergraduates and Postdocs (GETUP),
\textbf{Institutional Board Representative}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2018 - Aug 2019}}: UMD
Women in Physics Mentoring Program, \textbf{Mentor}

\hangindent=0.4in \textcolor{mygray}{\textit{Aug 2018 - Aug 2019}}: UMD
Physics Graduate Student Committee, \textbf{Elected Member}

\hangindent=0.4in \textcolor{mygray}{\textit{Mar 2018}}: American
Association for the Advancement of Science; Catalyzing Advocacy in
Science and Engineering Workshop, \textbf{Representative on Behalf of
UMD}

\hangindent=0.4in \textcolor{mygray}{\textit{Feb 2017 - Sep 2019}}: UMD
Physics Equity Constellation, \textbf{Member}
