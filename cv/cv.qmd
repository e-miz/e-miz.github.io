...
#    biblatexoptions: [bibstyle=publist, plauthorfirstinit=true, plauthorhandling=highlight, plnumbering=none, hlyear=true, marginyear=false, linktitles=all, doi=false, url=false, isbn=false]
#    include-before-body:
#      text: |
...
service_df = cv_df.loc[(cv_df["Type"] == "Service") & (cv_df["Start Date"] > "2017-01-01")].loc[:, ["Item", "Description", "Start Date", "End Date"]]

award_df = cv_df.loc[(cv_df["Type"] == "Award") & (cv_df["Start Date"] > "2017-01-01")].loc[:, ["Item", "Description", "Start Date", "End Date"]]
```
